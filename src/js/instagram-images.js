(function () {
    var bg = document.getElementById('js-background'),
        credit = {
            link: document.getElementById('js-credit'),
            date: document.getElementById('js-credit-date'),
            description: document.getElementById('js-credit-description')
        },
        images = [
            {
                ...
                credit: {
                    description: 'Moorina Road, Moorina Qld.',
            ...
            },
            {
                ...
                credit: {
                    description: 'Foreshore &amp; Jetty, Sandgate, Qld.',
            ...
            },
            {
                ...
                credit: {
                    description: 'Jetty, Redcliffe, Qld.',
            ...
            },
            {
                ...
                credit: {
                    description: 'Browns Creek Road, Narangba, Qld.',
    ...
    credit.link.setAttribute('href', images[random].url);
    credit.description.innerHTML = images[random].credit.description;
    credit.date.innerHTML = images[random].credit.date;
}());